...
def diffeomorphism(x_robot, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge):
    ...
    a = 1
    b = 1.1
    beta1 = ((x_robot[0]-x_obstacle_edge[0]-a)**2 + (x_robot[1]-x_obstacle_edge[1])**2) * ((x_robot[0]-x_obstacle_edge[0]+a)**2 + (x_robot[1]-x_obstacle_edge[1])**2) - b**4
    beta_dash0 = beta1
    beta_dash1 = beta0
...
def main():
    ...
    x_robot = np.array([0.45, 2.5])
    q_robot = np.array([0.0, 0.0])
    r_obstacle, theta = calculate_r(x_robot, x_obstacle)
    ...
    F = diffeomorphism(x_robot, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
    q_robot[0] = F[0]
    q_robot[1] = F[1]
    ...
    while t < t_max:
        ...
        Fx = diffeomorphism(x_h, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        Fy = diffeomorphism(y_h, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        F = diffeomorphism(x_robot, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        ...
        Fx = diffeomorphism(qx_h, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        Fy = diffeomorphism(qy_h, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        F = diffeomorphism(q_robot, x_bw, r_bw, x_obstacle, r_obstacle, q_obstacle, rho_bw, rho_obstacle, x_goal, q_goal, lam, x_obstacle_edge)
        J11s = float((Fx[0]-F[0])/H)
        J12s = float((Fy[0]-F[0])/H)
        J21s = float((Fx[1]-F[1])/H)
        J22s = float((Fy[1]-F[1])/H)
