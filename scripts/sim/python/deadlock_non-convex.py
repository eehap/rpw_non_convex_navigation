...
def main():
    ...
    gamma = 1000
    lam = 1000
    q_obstacle_t0 = np.array([0.0, 0.5])
    t = 0.0
    x_obstacle = np.array([0.0, 0.5])

    q_obstacle = np.array([0.0, 0.5])
    x_bw = np.array([0.0, 0.0])
    q_bw = np.array([0.0, 0.0])
    x_robot = np.array([0.0, 2.5])
    q_robot = np.array([0.0, 2.5])
